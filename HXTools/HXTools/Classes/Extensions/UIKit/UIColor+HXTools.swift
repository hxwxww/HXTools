...
public typealias HXRGBAValue = (red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat)

// MARK: -  UIColor通用封装
extension UIColor {
    
    /// r，g，b，a的值
    open var hx_rgbaValue: HXRGBAValue {
        var red: CGFloat = 0
        var green: CGFloat = 0
        var blue: CGFloat = 0
        var alpha: CGFloat = 0
    ...
    ///
    /// - Returns: 颜色实例
    open class func hx_randomColor() -> UIColor {
    ...
    ///   - toValue: 结束值
    /// - Returns: 颜色实例
    open class func hx_randomColor(fromValue: CGFloat, toValue: CGFloat) -> UIColor {
    ...
    ///   - percent: 中间值
    /// - Returns: 新的颜色实例
    open class func hx_averageColor(fromColor: UIColor, toColor: UIColor, percent: CGFloat) -> UIColor {
